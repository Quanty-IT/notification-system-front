...
type TemplateBodyType = CreateTemplateVersionFormData['bodyType'];

const hasHtmlOpeningTag = (body: string) => {
...
const inferBodyType = (body: string): TemplateBodyType => {
  ...
  return hasHtmlOpeningTag(body) ? 'html' : 'text';
};
...
export const CreateTemplateVersionDrawer = ({ isOpen, onClose, templateId }: Props) => {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CreateTemplateVersionFormData>({
  ...
  const onSubmit = (data: CreateTemplateVersionFormData) => {
    mutation.mutate({
      templateId,
      ...
      <Drawer.Positioner>
        <Drawer.Content bg='background' borderTopLeftRadius='2xl' borderBottomLeftRadius='2xl' boxShadow='xl'>
          ...
          <Drawer.Body px={8} py={4} overflowY='auto' w='full'>
            <VStack
              as='form'
              id='create-template-version-form'
              w='full'
              gap={6}
              align='stretch'
          ...
          <Drawer.Footer px={8} py={6} borderTop='1px solid' borderColor='inputBorder'>
            <HStack w='full' justify='flex-end' gap='3'>
              ...
              <Button
                type='submit'
                form='create-template-version-form'
                h='11'
                px='6'
                borderRadius='xl'
                bg='primary'
